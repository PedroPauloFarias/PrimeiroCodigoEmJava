package atividades.atividade26.model.entities;
...
public class Account {
    ...
    public void withdraw(Double amount) {
        validateWithdraw(amount); // Aqui o metodo esta sendo chamado
        balance -= amount;
    }

// Aqui ele verifica se esta dentro do limite estabelecido
